            ...
            switch ($menu) {
                ...
                case 2:
                    if (isset($_GET['clanak'])) {
                        ...
                        switch ($clanak) {
                            case 1: include 'articles/article1.php'; break;
                            case 2: include 'articles/article2.php'; break;
                            case 3: include 'articles/article3.php'; break;
                            case 4: include 'articles/article4.php'; break;
                            case 5: include 'articles/article5.php'; break;
                            default: include 'content/novosti.php'; break;
                        }
                    } else {
